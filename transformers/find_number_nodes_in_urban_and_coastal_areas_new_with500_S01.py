...
#### Find number of transformers that are not in urban or coastal areas but Vn[kV] contains 500 #####
...
# !!!!! This line does not work for S03
...
#gdf_500kV_HVAC_outside_urban_and_coastal = gpd.GeoDataFrame(df_500kV_HVAC_outside_urban_and_coastal, geometry='geometry')
#gdf_500kV_HVAC_outside_urban_and_coastal = gdf_500kV_HVAC_outside_urban_and_coastal.set_crs('EPSG:4326', allow_override=True, inplace=True)
#gdf_500kV_HVAC_outside_urban_and_coastal = gdf_500kV_HVAC_outside_urban_and_coastal.to_crs('ESRI:102008')
# Display the filtered DataFrame
#print(gdf_500kV_HVAC_outside_urban_and_coastal)
...
if scenario_name == 'S03':
    ...
    ## Filter for those DC transformer locations that are 500 and higher
...
if scenario_name == 'S03':
    ...
    # percent HVDC outside 

    total_500kV_and_higher_outside_urban_and_coastal = df_merged_500kV_HVAC_outside_urban_and_coastal['Total required units'].sum()
    total_sf6_transformers = df_merged_both['Total required units'].sum() + total_500kV_and_higher_outside_urban_and_coastal
    print('Total number of HVAC transformers 500 kV or higher outside of urban and coastal areas:' + str(total_500kV_and_higher_outside_urban_and_coastal))
    print(f'Percent HVAC 500 kV or higher outside of urban and coastal areas: {scenario_name}: {total_500kV_and_higher_outside_urban_and_coastal/number_hvac_transformers_for_scenario3*100}')
    print(f'Percent total SF6 HVAC transformers: {total_sf6_transformers/number_hvac_transformers_for_scenario3 * 100}')
